...
type Dashboard = { telegram: { status: string }; database: { status: string; error?: string }; downloads: { active: number; failedItems: number }; upstreamVersion: string; system: { current: Point; trend: Point[] } }
